      ...
      <form className="workspace" onSubmit={onSubmit}>
        ...
        <section className="panel form-panel">
          ...
          <div className="form-grid">
            ...
            <label>Country of Origin for Imports<input value={applicationData.country_of_origin} onChange={(e) => updateField('country_of_origin', e.target.value)} placeholder="Leave blank for domestic labels" /></label>
          </div>
